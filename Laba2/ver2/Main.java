            ...
            switch (enter){
                case 1: {                  ///TaskOne
                    ...
                    do {
                        ...
                        switch (enter1){
                            case 1: TaskName.TaskOneOne();
                                break;
                            case 2: TaskName.TaskOneTwo();
                                break;
                            case 3: TaskName.TaskOneThree();
                                break;
                            case 4: TaskName.TaskOneFour();
                                break;
                        }
                ...
                case 2: {                     ///TaskTwo
                    ...
                    do {
                        ...
                        switch (enter2){
                            case 1: TaskName.TaskTwoOne();
                                break;
                            case 2: TaskName.TaskTwoTwo();
                                break;
                            case 3: TaskName.TaskTwoThree();
                                break;
                        }
